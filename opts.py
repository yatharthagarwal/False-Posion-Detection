...
def parse_args():
    ...
    parser.add_argument('--dataset_method', type=str, default='labelrandom', choices=['randomlabelswap', 'interclasslabelswap', 'poisoning', 'none'], help='Number of Classes')
    parser.add_argument('--unlearn_method', type=str, default='Naive', choices=['Naive', 'EU', 'CF', 'Scrub', 'BadT', 'SSD'], help='Method for unlearning')
